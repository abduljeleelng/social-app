        ...
        <div className="user-post">
          <div className="d-flex">
            <div className="col-md-6">
              <a href="javascript:void();"><img src="images/page-img/p2.jpg" alt="post" className="img-fluid rounded w-100" /></a>
            </div>
            <div className="col-md-6 row m-0 p-0">
              <div className="col-sm-12">
                <a href="javascript:void();"><img src="images/page-img/p1.jpg" alt="post" className="img-fluid rounded w-100" /></a>
              </div>
              <div className="col-sm-12 mt-3">
                <a href="javascript:void();"><img src="images/page-img/p3.jpg" alt="post" className="img-fluid rounded w-100" /></a>
              </div>
            </div>
          </div>
        </div>
